...
public:
    ...
    static bool refract(const Vec3& incident, const Vec3& normal, double refractiveIndex, Vec3& refracted) {
        ...
        if (sin_theta > 1.0 / refractiveIndex) {
            return false;
        }
    ...
    Vec3 rotate(double angle, const Vec3& axis) const {
        ...
        double rotatedX = rotationMatrix[0][0] * x + rotationMatrix[0][1] * y + rotationMatrix[0][2] * z;
        double rotatedY = rotationMatrix[1][0] * x + rotationMatrix[1][1] * y + rotationMatrix[1][2] * z;
        double rotatedZ = rotationMatrix[2][0] * x + rotationMatrix[2][1] * y + rotationMatrix[2][2] * z;
